---
title: "Python 容器类实现与魔术方法：自定义 list/dict、拷贝与正则实战"
date: 2025-06-12T00:00:00+08:00
draft: false
author: "Zack-Zhang1031"
description: "用魔术方法自定义 MyList/MyDict，理解 dict 的浅拷贝原理、str.format_map 用法，以及 re.sub 配合函数的进阶用法。"
tags: ["Python", "魔术方法", "容器类"]
categories: ["Python", "编程基础"]
---

Python 的「魔术方法」（dunder methods）是连接自定义类与内置语法糖的桥梁——写好 `__getitem__`、`__setitem__`，你的类就能像 list、dict 一样被索引和赋值。这篇笔记从手写 MyList/MyDict 出发，串起拷贝原理、字符串格式化与正则替换，帮助你"知其然，更知其所以然"。
