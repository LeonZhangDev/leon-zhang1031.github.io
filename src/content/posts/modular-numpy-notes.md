---
title: "模块化编程与 NumPy 基础：ndarray 创建、切片、广播与内存机制"
date: 2025-06-28T00:00:00+08:00
draft: false
author: "Zack-Zhang1031"
description: "从 Python 模块/包的导入规范出发，系统梳理 NumPy ndarray 的创建、切片、维度变换、广播机制，以及视图与副本的内存原理。"
tags: ["Python", "NumPy", "模块化", "科学计算"]
categories: ["Python", "科学计算"]
---

工程化的 Python 离不开两件事：把代码拆成可复用的模块，以及用 NumPy 高效处理数据。这篇笔记前半段讲模块、包与第三方库管理，后半段深入 ndarray 的创建、切片、广播与"视图 vs 副本"的内存机制——后者是写出高性能数值计算代码的关键。
...
模块化解决代码依赖，数组视图解决内存共享，两者会在函数边界相遇。一个函数若原地修改输入视图，可能改变调用方的原数组。接口说明里应写清是否修改输入，比一律复制或一律追求零拷贝更容易维护。
